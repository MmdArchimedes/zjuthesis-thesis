...
\documentclass[
    ...
    % Title
    Title           = 面向计量经济分析的AR可视化交互系统,
    TitleEng        = {{An AR visual interactive system for econometric analysis}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
 \titletwolines{面向计量经济分析的}{AR可视化交互系统}
 \titleengtwolines{An AR visual interactive system}{for econometric analysis}
