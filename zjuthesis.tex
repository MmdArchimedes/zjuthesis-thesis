...
\documentclass[
    ...
    % Title
    Title           = 省域数字经济与能源结构的AR沉浸式分析系统研究,
    TitleEng        = {{An AR Immersive Analytics System for Provincial Digital Economy and Energy Structure}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
 \titletwolines{省域数字经济与能源结构的}{AR沉浸式分析系统研究}
 \titleengtwolines{An AR Immersive Analytics System for}{Provincial Digital Economy and Energy Structure}
