...
\begin{table}[htbp]
  ...
  \hline
  单指向左 (Year-1) & 0.678 & 0.954 & 0.970 \\
  单指向右 (Year+1) & 0.637 & 0.966 & 0.978 \\
  二指手心 (DEL) & 0.666 & 0.982 & 0.988 \\
  二指手背 (ES) & 0.685 & 0.993 & 0.994 \\
  四指手心 (Main) & 0.745 & 0.894 & 0.921 \\
  握拳 (Reset) & 0.695 & 0.990 & 0.993 \\
  \hline
  宏平均 F1 & 0.684 & 0.955 & 0.967 \\
  \hline
  \end{tabular}
